...
execute if data storage meowinternal:temp {FoundRightColorBool:1} \
    ...
    run tellraw @a ["",{"text":"[VAL] ","color":"dark_purple","bold":true},{"text":"Player ","color":"green"},{"selector":"@s","color":"light_purple"},{"text":" has joined the ","color":"green"},{"text":"Defenders","color":"aqua","bold":true},{"text":" side!","color":"green"}]
execute if data storage meowinternal:temp {FoundRightColorBool:1} \
    if data storage meowinternal:valorant {InvertTeamColors:1} \
    run tellraw @a ["",{"text":"[VAL] ","color":"dark_purple","bold":true},{"text":"Player ","color":"green"},{"selector":"@s","color":"light_purple"},{"text":" has joined the ","color":"green"},{"text":"Defenders","color":"red","bold":true},{"text":" side!","color":"green"}]

execute store success storage meowinternal:temp TeamJoinSuccess int 1 run team join VAL_DEF

execute if data storage meowinternal:temp {TeamJoinSuccess:0} \
    run team add VAL_DEF ["",{"text":"Defenders","color":"aqua"}]
execute if data storage meowinternal:temp {TeamJoinSuccess:0} \
...
execute if data storage meowintenral:temp {TeamJoinSuccess:0} \
    run team modify VAL_DEF nametagVisibility hideForOtherTeams
execute if data storage meowintenral:temp {TeamJoinSuccess:0} \
    run team modify VAL_DEF friendlyFire false
execute if data storage meowintenral:temp {TeamJoinSuccess:0} \
    run team modify VAL_DEF seeFriendlyInvisibles false
...
execute if data storage meowinternal:temp {FoundRightColorBool:1} \
    if data storage meowinternal:valorant {InvertTeamColors:1} \
    run team modify VAL_DEF prefix ["",{"text":"[","color":"dark_red","bold":true},{"text":"Defender","color":"red","bold":true},{"text":"] ","color":"dark_red"}]
...
scoreboard players set @s VAL_TEAMS 0
